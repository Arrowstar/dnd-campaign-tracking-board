...
const SHORTCUT_GROUPS: { title: string; icon: React.ReactNode; rows: ShortcutRow[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { keys: ['Ctrl', 'D'], action: 'Duplicate the selected card', detail: 'Ctrl + D — copies the card +24px with a fresh id (Ctrl + Alt + D on Firefox — it reserves Ctrl + D for bookmarking)' },
